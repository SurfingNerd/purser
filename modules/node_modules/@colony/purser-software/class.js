...
class SoftwareWallet {
    ...
    get publicKey() {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            ...
            const reversedPublicKey = ethereumjs_util_1.privateToPublic(privateKeyBuffer).toString(defaults_1.HEX_HASH_TYPE).toString(); //toString() needs to get called an additional time, because toString() might return a Buffer.
            /*
