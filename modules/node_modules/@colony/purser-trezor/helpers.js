 ...
 */
exports.promptGenerator = ({ serviceUrl = exports.serviceUrlGenerator({ keyValue: new Date().getTime() }), windowFeatures = exports.windowFeaturesSerializer(defaults_2.WINDOW_FEATURES), } = {}) => window.open(serviceUrl, defaults_2.WINDOW_NAME, windowFeatures);
/**
 ...
 */
exports.payloadListener = ({ payload, origin: payloadOrigin = defaults_2.SERVICE_DOMAIN, } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        const prompt = exports.promptGenerator();
        const messageListener = event => {
            const { data, isTrusted, origin } = event;
            const sameOrigin = prompt && exports.sanitizeUrl(payloadOrigin) === exports.sanitizeUrl(origin);
