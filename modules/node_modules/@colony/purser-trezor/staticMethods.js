...
exports.signTransaction = (obj) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const unsignedTransaction = new ethereumjs_tx_1.Transaction({
        ...
        gasLimit: normalizers_1.hexSequenceNormalizer(normalizers_1.multipleOfTwoHexValueNormalizer(gasPrice)),
        /*
    ...
    const modifiedPayloadObject = Object.assign({}, payloads_1.PAYLOAD_SIGNTX, {
        ...
        gas_price: normalizers_1.multipleOfTwoHexValueNormalizer(gasPrice),
        gas_limit: normalizers_1.multipleOfTwoHexValueNormalizer(gasLimit),
        chain_id: chainId,
        nonce: normalizers_1.multipleOfTwoHexValueNormalizer(nonce.toString(16)),
        value: normalizers_1.multipleOfTwoHexValueNormalizer(value),
        /*
    ...
    try {
        ...
        unsignedTransaction.v = Buffer.from(normalizers_1.hexSequenceNormalizer(utils_1.bigNumber(recoveryParameter).toString(16)), defaults_1.HEX_HASH_TYPE);
