...
exports.signTransaction = (obj) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { chainId, gasPrice, gasLimit, to, value, inputData, nonce } = helpers_1.transactionObjectValidator(transactionObject);
    const { from } = obj;
     ...
     */
    if (manualNonce) {
        validators_1.safeIntegerValidator(manualNonce);
        utils_1.warning(messages_1.staticMethods.dontSetNonce);
    }
    /*
...
exports.signMessageCallback = (resolve, reject) => (error, messageSignature) => {
    try {
        if (error) {
            /*
